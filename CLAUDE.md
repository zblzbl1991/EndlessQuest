...
- **Roguelike 构建层**：每 2 层选祝福（13 种），通关获遗物（7 种），每局搭配不同
...
### 用户
仙侠挂机放置游戏爱好者与 Roguelike 策略玩家的交集人群。熟悉修仙放置/挂机类手游的"上线收菜"体验，也喜欢以撒、杀戮尖塔等 Roguelike 的"每次都不一样"的随机获取乐趣。主要在碎片时间和晚间放松时段游玩，上线看弟子修炼进度、收秘境战利品、决定下一次冒险押注。
