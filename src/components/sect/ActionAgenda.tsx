...
export default function ActionAgenda() {
  ...
  const items = useMemo(() => {
    ...
    for (const char of sect.characters) {
      ...
      if (progress > 0.9 && canBreakthrough(char)) {
        ...
        result.push({
          ...
          priority: 1,
          label: `${char.name} 即将突破`,
          detail: `需要 ${cost.toLocaleString()} 灵石`,
          link: '/characters',
        })
      }
    }
    ...
    const resourceChecks = [
      ...
      { name: '矿石', value: sect.resources.ore, cap: caps.ore },
    ]
  ...
  return (
    <div className={styles.container}>
      <div className={styles.title}>修行要务</div>
