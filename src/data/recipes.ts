...
export const AUTO_RECIPES: AutoRecipe[] = [
  ...
  },
  {
    ...
    buildingType: 'forge',
    minLevel: 5,
    inputPerSec: { spiritStone: 4.5, ore: 0.25 },
    totalCost: { spiritStone: 540, herb: 0, ore: 30 },
    productionTime: 120,
    productType: 'equipment',
  },
  {
    ...
    buildingType: 'forge',
    minLevel: 5,
    inputPerSec: { spiritStone: 4.0, ore: 0.3 },
    totalCost: { spiritStone: 480, herb: 0, ore: 36 },
    productionTime: 120,
    productType: 'equipment',
  },
  {
    ...
    buildingType: 'forge',
    minLevel: 7,
    inputPerSec: { spiritStone: 12.0, ore: 0.5 },
    totalCost: { spiritStone: 3600, herb: 0, ore: 150 },
    productionTime: 300,
    productType: 'equipment',
  },
  {
    ...
    buildingType: 'forge',
    minLevel: 7,
    inputPerSec: { spiritStone: 11.0, ore: 0.6 },
    totalCost: { spiritStone: 3300, herb: 0, ore: 180 },
    productionTime: 300,
    productType: 'equipment',
  },
]
