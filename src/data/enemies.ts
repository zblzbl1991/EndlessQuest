...
export const ENEMY_TEMPLATES: EnemyTemplate[] = [
  ...
  // --- BiQuan Stream (碧泉溪) - Water spirits, easy+ difficulty ---
  {
    ...
    dropsPerFight: 1,
    lootTable: [
      { type: 'spiritStone', weight: 38, minAmount: 20, maxAmount: 55 },
      { type: 'herb', weight: 25, minAmount: 3, maxAmount: 10 },
      { type: 'ore', weight: 12, minAmount: 1, maxAmount: 4 },
      { type: 'equipment', weight: 10, quality: 'common' },
  ...
  {
    id: 'stream_jade_turtle',
    name: '玉龟',
    element: 'neutral',
    stats: { hp: 72, atk: 9, def: 10, spd: 4 },
    isBoss: false,
    affixPool: ['shield'],
    dropsPerFight: 1,
    lootTable: [
      { type: 'spiritStone', weight: 35, minAmount: 22, maxAmount: 60 },
      { type: 'herb', weight: 22, minAmount: 3, maxAmount: 9 },
      { type: 'ore', weight: 15, minAmount: 2, maxAmount: 5 },
      { type: 'equipment', weight: 10, quality: 'common' },
  ...
  },
  {
    ...
    dropsPerFight: 3,
    lootTable: [
      { type: 'spiritStone', weight: 28, minAmount: 80, maxAmount: 220 },
      { type: 'herb', weight: 18, minAmount: 8, maxAmount: 22 },
      { type: 'ore', weight: 10, minAmount: 3, maxAmount: 10 },
      { type: 'equipment', weight: 15, quality: 'spirit' },
      { type: 'equipment', weight: 8, quality: 'immortal' },
      { type: 'petCapture', weight: 5 },
  ...
  // --- AnYa Forest (暗鸦林) - Dark forest, crows, medium+ difficulty ---
  {
    id: 'forest_dark_crow',
    name: '暗鸦',
    element: 'neutral',
    stats: { hp: 115, atk: 20, def: 9, spd: 12 },
    isBoss: false,
    affixPool: ['swift'],
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 35, minAmount: 40, maxAmount: 90 },
      { type: 'herb', weight: 12, minAmount: 3, maxAmount: 9 },
      { type: 'ore', weight: 15, minAmount: 2, maxAmount: 8 },
      { type: 'equipment', weight: 6, quality: 'common' },
      { type: 'equipment', weight: 10, quality: 'spirit' },
  ...
  {
    id: 'forest_thorn_wolf',
    name: '荆棘狼',
    element: 'fire',
    stats: { hp: 135, atk: 22, def: 11, spd: 10 },
    isBoss: false,
    affixPool: ['berserk'],
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 35, minAmount: 45, maxAmount: 100 },
      { type: 'herb', weight: 10, minAmount: 3, maxAmount: 10 },
      { type: 'ore', weight: 15, minAmount: 3, maxAmount: 9 },
      { type: 'equipment', weight: 5, quality: 'common' },
      { type: 'equipment', weight: 10, quality: 'spirit' },
  ...
  },
  {
    ...
    isBoss: true,
    affixPool: ['swift', 'spiritDrain'],
    skillIds: ['ice_blade', 'sword_qi'],
    dropsPerFight: 3,
    lootTable: [
      { type: 'spiritStone', weight: 28, minAmount: 100, maxAmount: 280 },
      { type: 'herb', weight: 12, minAmount: 8, maxAmount: 22 },
      { type: 'ore', weight: 10, minAmount: 5, maxAmount: 14 },
      { type: 'equipment', weight: 12, quality: 'spirit' },
      { type: 'equipment', weight: 10, quality: 'immortal' },
      { type: 'equipment', weight: 3, quality: 'divine' },
      { type: 'petCapture', weight: 5 },
  ...
  // --- HanBing Cave (寒冰石窟) - Ice/frozen beasts, high+ difficulty ---
  {
    ...
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 35, minAmount: 70, maxAmount: 160 },
      { type: 'herb', weight: 10, minAmount: 5, maxAmount: 14 },
      { type: 'ore', weight: 15, minAmount: 5, maxAmount: 15 },
      { type: 'equipment', weight: 4, quality: 'common' },
      { type: 'equipment', weight: 10, quality: 'spirit' },
      { type: 'equipment', weight: 6, quality: 'immortal' },
      { type: 'petCapture', weight: 3 },
    ],
  },
  {
    ...
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 35, minAmount: 75, maxAmount: 170 },
      { type: 'herb', weight: 8, minAmount: 5, maxAmount: 12 },
      { type: 'ore', weight: 18, minAmount: 6, maxAmount: 18 },
      { type: 'equipment', weight: 3, quality: 'common' },
      { type: 'equipment', weight: 10, quality: 'spirit' },
      { type: 'equipment', weight: 8, quality: 'immortal' },
  ...
  },
  {
    ...
    dropsPerFight: 3,
    lootTable: [
      { type: 'spiritStone', weight: 25, minAmount: 150, maxAmount: 450 },
      { type: 'herb', weight: 10, minAmount: 10, maxAmount: 28 },
      { type: 'ore', weight: 10, minAmount: 6, maxAmount: 20 },
      { type: 'equipment', weight: 10, quality: 'spirit' },
      { type: 'equipment', weight: 12, quality: 'immortal' },
      { type: 'equipment', weight: 4, quality: 'divine' },
      { type: 'petCapture', weight: 5 },
  ...
  // --- ShiHun Swamp (噬魂沼泽) - Soul-devouring swamp, very high+ difficulty ---
  {
    id: 'swamp_soul_eater',
    name: '噬魂蛭',
    element: 'neutral',
    stats: { hp: 290, atk: 40, def: 18, spd: 13 },
    isBoss: false,
    affixPool: ['spiritDrain', 'swift'],
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 30, minAmount: 100, maxAmount: 220 },
      { type: 'herb', weight: 8, minAmount: 6, maxAmount: 16 },
      { type: 'ore', weight: 14, minAmount: 8, maxAmount: 20 },
      { type: 'equipment', weight: 2, quality: 'common' },
      { type: 'equipment', weight: 8, quality: 'spirit' },
      { type: 'equipment', weight: 8, quality: 'immortal' },
      { type: 'equipment', weight: 2, quality: 'divine' },
  ...
  },
  {
    ...
    name: '腐沼兽',
    element: 'fire',
    stats: { hp: 330, atk: 36, def: 24, spd: 9 },
    isBoss: false,
    affixPool: ['berserk', 'shield'],
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 30, minAmount: 110, maxAmount: 240 },
      { type: 'herb', weight: 6, minAmount: 6, maxAmount: 18 },
      { type: 'ore', weight: 14, minAmount: 8, maxAmount: 22 },
      { type: 'equipment', weight: 2, quality: 'common' },
  ...
  {
    id: 'swamp_abyss_hydra',
    name: '渊沼九头蛇',
    element: 'fire',
    stats: { hp: 340, atk: 44, def: 22, spd: 12 },
    isBoss: true,
    affixPool: ['berserk', 'shield', 'spiritDrain', 'tribulationBane'],
    skillIds: ['fire_palm', 'ice_blade'],
    dropsPerFight: 3,
    lootTable: [
      { type: 'spiritStone', weight: 22, minAmount: 250, maxAmount: 650 },
      { type: 'herb', weight: 10, minAmount: 12, maxAmount: 32 },
      { type: 'ore', weight: 10, minAmount: 10, maxAmount: 28 },
      { type: 'equipment', weight: 8, quality: 'spirit' },
      { type: 'equipment', weight: 14, quality: 'immortal' },
  ...
  // --- WanYao Palace (万妖殿) - Demon palace, extreme+ difficulty ---
  {
    id: 'palace_demon_guard',
    name: '妖殿护卫',
    element: 'fire',
    stats: { hp: 400, atk: 48, def: 26, spd: 14 },
    isBoss: false,
    affixPool: ['berserk', 'swift'],
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 28, minAmount: 150, maxAmount: 350 },
      { type: 'herb', weight: 6, minAmount: 8, maxAmount: 22 },
      { type: 'ore', weight: 12, minAmount: 10, maxAmount: 26 },
      { type: 'equipment', weight: 2, quality: 'common' },
      { type: 'equipment', weight: 6, quality: 'spirit' },
      { type: 'equipment', weight: 10, quality: 'immortal' },
      { type: 'equipment', weight: 4, quality: 'divine' },
  ...
  },
  {
    ...
    dropsPerFight: 2,
    lootTable: [
      { type: 'spiritStone', weight: 28, minAmount: 160, maxAmount: 380 },
      { type: 'herb', weight: 5, minAmount: 8, maxAmount: 20 },
      { type: 'ore', weight: 12, minAmount: 10, maxAmount: 28 },
      { type: 'equipment', weight: 2, quality: 'common' },
      { type: 'equipment', weight: 5, quality: 'spirit' },
      { type: 'equipment', weight: 12, quality: 'immortal' },
      { type: 'equipment', weight: 5, quality: 'divine' },
  ...
  },
  {
    ...
    skillIds: ['thunder_strike', 'fire_palm', 'sword_qi'],
    dropsPerFight: 3,
    lootTable: [
      { type: 'spiritStone', weight: 20, minAmount: 350, maxAmount: 1000 },
      { type: 'herb', weight: 8, minAmount: 16, maxAmount: 42 },
      { type: 'ore', weight: 8, minAmount: 12, maxAmount: 35 },
      { type: 'equipment', weight: 6, quality: 'spirit' },
      { type: 'equipment', weight: 12, quality: 'immortal' },
...
export const DUNGEON_ENEMY_MAP: Record<string, { regular: string[]; boss: string }> = {
  ...
  biQuanStream: {
    regular: ['stream_water_sprite', 'stream_jade_turtle'],
    boss: 'stream_tide_serpent',
  },
  luoYunCave: {
  ...
  anYaForest: {
    regular: ['forest_dark_crow', 'forest_thorn_wolf'],
    boss: 'forest_nightshade_queen',
  },
  bloodDemonAbyss: {
  ...
  hanBingCave: {
    regular: ['cave_ice_elemental', 'cave_frost_golem'],
    boss: 'cave_blizzard_dragon',
  },
  dragonBoneWasteland: {
  ...
  shiHunSwamp: {
    regular: ['swamp_soul_eater', 'swamp_rot_beast'],
    boss: 'swamp_abyss_hydra',
  },
  nineNetherPurgatory: {
  ...
  wanYaoPalace: {
    regular: ['palace_demon_guard', 'palace_shadow_assassin'],
    boss: 'palace_demon_emperor',
  },
